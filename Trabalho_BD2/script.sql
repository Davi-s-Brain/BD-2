...
-- *--------------------------------------------
-- * DB-MAIN version: 22.0.2              
-- * Generator date: Sep 24 2022              
-- * Generation date: Thu Jun 22 27:05:37 2025 
-- * LUN file: C:\Users\Windows\OneDrive\Documentos\GitHub\BD-2\Trabalho_BD2\Trabalho BD2 v22-06-2025.lun 
-- * Schema: SQL/SQL 
-- ********************************************* 
...
create table Ambiente (
     ...
     Quantidade_desse_ambiente float(2) not null,
...
create table Cliente (
     ...
     Telefone_client numeric(13) not null,
     E_mail_client varchar(50) not null,
     Data_cadastro_client date not null,
     Genero_client varchar(20) not null,
